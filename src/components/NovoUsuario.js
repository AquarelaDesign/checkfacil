...
const NovoUsuario = ({ navigation, pemail }) => {
  ...
  useEffect(() => {
    ...
    // console.log('*** navigation', navigation.setOptions, navigation.setParams)
    ...
    {/* <SafeAreaView style={[GlobalStyles.container, {paddingTop: 40,}]}> */}
      ...
      >
        <View style={styles.row}>
          <Icon name="user-plus" size={40} color="#007189" style={{marginLeft: 20, marginTop: 30, marginBottom: 10, }}/>
