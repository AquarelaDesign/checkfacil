      ...
      async function GravaToken() {
        try {
          await Api.post('', querystring.stringify({
            ...
            if (response.status === 200) {
              ...
              if (Platform.OS === 'android' || Platform.OS === 'ios') {
                ...
                console.log('*** Toast:', Platform.OS, `Falha ao atualiar [${tipo}]`)
              }
            }
          })
        } catch (error) {
          ...
          if (Platform.OS === 'android' || Platform.OS === 'ios') {
            ...
            console.log('*** Toast:', Platform.OS, 'Falha na comunicação [GT]')
          }
        }
      }
      GravaToken()
    ...
    try {
      ...
      if (type === 'success') {
        ...
        if (Platform.OS === 'android' || Platform.OS === 'ios') {
          ...
          console.log('*** Toast:', Platform.OS, `Falha na comunicação [${type}]`)
        }
      }
    } catch ({ message }) {
      if (Platform.OS === 'android' || Platform.OS === 'ios') {
        ...
        console.log('*** Toast:', Platform.OS, `Facebook Login Error: ${message}`)
      }
    }
  ...
  const handleRecuperar = async () => {
    if (email === '') {
      if (Platform.OS === 'android' || Platform.OS === 'ios') {
        ...
        console.log('*** Toast:', Platform.OS, 'Preencha o campo e-mail e tente novamente...')
      }
      return
    }
    ...
    try {
        ...
        if (response.status === 200) {
          if (response.data.ProDataSet !== undefined) {
            ...
            if (Platform.OS === 'android' || Platform.OS === 'ios') {
              ...
              console.log('*** Toast:', Platform.OS, ttretorno[0].mensagem)
            }
      ...
      if (response !== undefined) {
        ...
        if (Platform.OS === 'android' || Platform.OS === 'ios') {
          ...
          console.log('*** Toast:', Platform.OS, 'Falha ao conectar com o servidor, por favor tente mais tarde.')
        }
      }
    }
        ...
        await Api.post('', querystring.stringify({
          ...
          if (response.status === 200) {
            ...
            if (Platform.OS === 'android' || Platform.OS === 'ios') {
              ...
              console.log('*** Toast:', Platform.OS, response.status)
            }
          }
        })
  ...
  const GravaSenha = async () => {
    ...
    if (novaSenha === confSenha) {
      ...
      if (Platform.OS === 'android' || Platform.OS === 'ios') {
        ...
        console.log('*** Toast:', Platform.OS, 'As senhas informadas não coincidem!')
      }
    }
  }
  ...
  const handleSubmit = async () => {
    ...
    if (email === '') {
      if (Platform.OS === 'android' || Platform.OS === 'ios') {
        ...
        console.log('*** Toast:', Platform.OS, 'E-mail deve ser informado!')
      }
      return
    }
    ...
    try {
          ...
          if (response.status === 200) {
            if (response.data === '') {
              if (Platform.OS === 'android' || Platform.OS === 'ios') {
                ...
                console.log('*** Toast:', Platform.OS, 'Usuário não encontrado!')
              }
            }
      ...
      if (response !== undefined) {
        if (Platform.OS === 'android' || Platform.OS === 'ios') {
          ...
          console.log('*** Toast:', Platform.OS, response.data.errors[0])
        }
      } else {
        if (Platform.OS === 'android' || Platform.OS === 'ios') {
          ToastAndroid.showWithGravity(
